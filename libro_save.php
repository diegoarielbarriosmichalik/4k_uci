...
$imagen = ' ';
//$anio = $_POST["anio"];
$num_pag = $_POST["paginas"];
//$id_categoria = $_POST["id_categoria"];
$id_autor = $_POST["id_autor"];
//$id_editorial = $_POST["id_editorial"];

$ISp_Res = $con->prepare(""
        . "INSERT INTO libro(id_libro, isbn, titulo, subtitulo,imagen, anio,num_pag,id_categoria, id_autor, id_editorial, img) "
        . "VALUES(?,?,?,?,?,?,?,?,?,?,?)");
$ISp_Res->execute(array($id_libro, $isbn, $titulo, $subtitulo, $imagen, 1, $num_pag, 1, $id_autor, 1, 0));
